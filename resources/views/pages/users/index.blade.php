                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <button class="btn btn-secondary" data-bs-toggle="modal"
                                    data-bs-target="#updateProduct{{ $user->id }}"
                                    @if ($user->role == 'admin') disabled @endif>Edit</button>
                                <div class="modal fade" id="updateProduct{{ $user->id }}" tabindex="-1"
                                ...
                                <button class="btn btn-danger" @if ($user->role == 'admin') disabled @endif
                                    data-bs-toggle="modal"
                                    data-bs-target="#deleteProduct{{ $user->id }}">Hapus</button>
                                <div class="modal fade" id="deleteProduct{{ $user->id }}" tabindex="-1"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <form method="POST"
                                                ...
                                                @method('delete')
                                                <div class="modal-body px-4">
                                                    <p class="py-4">Apakah anda yakin akan menghapus akun <span
                                                            class="fw-bold">{{ $user->name }}</span>?</p>
